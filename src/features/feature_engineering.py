...
from src.data.make_dataset import clean_text  # Assumes shared module; adjust if needed
...
def engineer_features(
    ...
    if use_bert:
        ...
        model_path = "../../models/features/bert_model"  # Use torch.save for full model if needed
...
if __name__ == "__main__":
    # Default: TF-IDF
    engineer_features(use_bert=True)
